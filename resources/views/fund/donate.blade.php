      ...
      <div class="col-md-6 col-lg-3 mb-5">
        <div class="person-donate text-center">
          ...
          <div class="donate-info">
            ...
            <p>Donated <span class="text-success">${{$doner->amount}}</span> <br> <em>for</em> <a href="{{route('home')}}" class="link-underline fundraise-item">{{$doner->campaign->campaign_name}}</a></p>
          </div>
